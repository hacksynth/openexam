...
- Attempt history, attempt report, and wrong-note review cards with status chips, paper/practice labels, knowledge chips, retry actions, filters, metrics, and long-stem wrapping.
