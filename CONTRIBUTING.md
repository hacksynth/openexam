...
- Keep generated dependency update pull requests small. Dependabot handles npm, GitHub Actions, and Docker base image updates weekly.
...
Repository infrastructure changes should keep `README.md`, `.github/`, `SECURITY.md`, `SUPPORT.md`, and release notes consistent. Changes to Dockerfiles should pass the Docker image build workflow or an equivalent local `docker build` check.
