...
- Unified Next.js web app with learner routes, `/admin` role routes, authenticated route protection, and health APIs.
- Prisma/PostgreSQL schema, migrations, seed data, and Docker Compose services for web, worker, and database.
